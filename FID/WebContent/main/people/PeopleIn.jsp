		...
		<form class="form-horizontal" action="../../peopleInrol.do"
			...
			<div class="form-group">
				<div class="form-inline">
					...
					<div class="form-group">
						<br>
						<div class="form-group form-horiziotal">
							<div class="form-inline">
			...
			<div class="form-group form-inline">
				...
				<input type="text" class="form-control" name="sido"
					...
					placeholder="군/구"> <input readonly="readonly" type="text"
			...
			<div class="form-gruop">
				<button type="submit"
					class="btn btn-success col-sm-1 col-sm-offset-4" id="submitBtn"
					disabled="disabled">제출</button>
			</div>
			<br>
		</form>
	</div>
