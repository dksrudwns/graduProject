 ...
 */
@WebServlet("/peopleUp.do")
public class peopleUp extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			try {
				...
				PeopleInDTO pDTO = new PeopleInDTO(peopleNum, null, zipCode, sido, sigungu, detailAddr, faceid,detail);
				pDAO.updatePeopleIn(pDTO);

				response.sendRedirect("./peopleList.do");
			} catch (Exception e) {
